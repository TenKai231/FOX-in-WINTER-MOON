...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (typeof L !== "undefined") {
    ...
    L.marker([64.2, -153.0], { icon: createPulseIcon("#A78BFA") })
      .addTo(map)
      .bindPopup(
        "<b style='color:#A78BFA;font-family:Cinzel'>North America — Origin</b><br><span style='font-size:11px;color:#9ca3af'>Eucyon davisi, 10 Mya. Ancestral canid birthplace.</span>",
      );

    L.marker([65.5, -168.0], { icon: createPulseIcon("#60A5FA") })
      .addTo(map)
      .bindPopup(
        "<b style='color:#60A5FA;font-family:Cinzel'>Bering Land Bridge</b><br><span style='font-size:11px;color:#9ca3af'>Gateway to Eurasia, used 10–12 Mya during glacial periods.</span>",
      );

    L.marker([55.0, 82.9], { icon: createPulseIcon("#A78BFA") })
      .addTo(map)
      .bindPopup(
        "<b style='color:#A78BFA;font-family:Cinzel'>Central Eurasia — Spread</b><br><span style='font-size:11px;color:#9ca3af'>Vulpes vulpes established, 1 Mya. Spread across Eurasia.</span>",
      );

    L.marker([51.5, -0.1], { icon: createPulseIcon("#FF8C42") })
      .addTo(map)
      .bindPopup(
        "<b style='color:#FF8C42;font-family:Cinzel'>British Isles — Today</b><br><span style='font-size:11px;color:#9ca3af'>~150,000 urban foxes. Highest density in the world.</span>",
      );
  ...
  const sciBtn = document.getElementById("sci-btn");
  if (exploreBtn)
    exploreBtn.onclick = () => window.open(eras[2].link, "_blank", "noopener");
  if (sciBtn)
    sciBtn.onclick = () => window.open(eras[2].sciLink, "_blank", "noopener");
