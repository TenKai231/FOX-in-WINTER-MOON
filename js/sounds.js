...
// Hero wave (animated)
buildWave("hero-wave", "#60A5FA",
    [50,75,60,100,45,85,65,90,50,70,55,80,40,95,60,75,50,100,65,80,45,70],
    true);
...
// ── Spectrogram builder ──
const specHeights = [40,60,20,85,45,30,100,55,25,70,40,15,90,50,35,75,60,45,80,25,65,90,50,35,70,95,40,60,30,85,55,20,75,45,65,100,50,35,80,60];
const specColors  = ["#60A5FA","#60A5FA","#93C5FD","#60A5FA","#A78BFA","#60A5FA","#60A5FA","#93C5FD","#A78BFA","#FF8C42"];
...
window.playSound = function(type) {
    ...
    osc.frequency.exponentialRampToValueAtTime(p.freq * 0.5, ctx.currentTime + p.duration);
